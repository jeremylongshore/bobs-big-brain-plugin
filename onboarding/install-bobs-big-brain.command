...
if [ -z "$code" ] || [ "$code" = "000" ]; then
  ...
  say "    • Accept your one-time team invite in a private browser window. You can"
  say "      use a passkey or your current identity provider; no Gmail account is needed."
  say "    • Run  tailscale switch  and select the team tailnet labeled"
  say "      intentsolutions.io (tail70fc2c). Your login email may be different."
